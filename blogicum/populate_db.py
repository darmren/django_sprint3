...
Post.objects.get_or_create(
    ...
    defaults={
        ...
        Робинзон Крузо, был выброшен полумёртвым
         на берег этого проклятого острова,
...
Post.objects.get_or_create(
    ...
    defaults={
        ...
        приливом и пригнало гораздо ближе к берегу.
...
Post.objects.get_or_create(
    ...
    defaults={
        ...
        и дул сильный порывистый ветер.
        Корабль за ночь разбило в щепки;
        на том месте, где он стоял, торчат какие-то
...
Post.objects.get_or_create(
    ...
    defaults={
        'text': '''Сегодня начал изучать Django -
        отличный фреймворк для веб-разработки!
        Создал свой первый проект Блогикум.
        Разобрался с моделями, представлениями и
...
Post.objects.get_or_create(
    title='Рецепт борща',
    defaults={
        'text': '''Сегодня приготовил настоящий борщ по бабушкиному рецепту.
        Секрет вкуса - в правильно приготовленной
        свекле и хорошем мясном бульоне.
...
Post.objects.get_or_create(
    ...
    defaults={
        'text': '''Это пост запланирован на
         будущее и пока не должен отображаться
        на сайте.''',
